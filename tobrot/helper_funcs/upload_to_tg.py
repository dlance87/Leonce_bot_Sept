...
async def upload_to_tg(
    ...
    if not (caption_str and edit_media):
        ...
        caption_str = "😎 For Daily Movies/Series Uploads "
        caption_str += "<code>"
    ...
    if os.path.isdir(local_file_name):
        ...
        if os.path.getsize(local_file_name) > TG_MAX_FILE_SIZE:
            ...
            i_m_s_g = await message.reply_text(
                "Unfortunately, Telegram does not support or allow 😎 uploading this amount of file size\n."
    ...
    try:
        ...
        if not edit_media:
            message_for_progress_display = await message.reply_text(
                "😉..let me start uploading.. of {}".format(os.path.basename(local_file_name))
            )
        if local_file_name.endswith(("MKV", "MP4", "WEBM")):
            ...
            if edit_media and message.photo:
                ...
                sent_message = await message.reply_video(
                    ...
                    progress_args=(
                        "patience💁‍♂️ ..while trying 🙇‍♂️🙇‍♂️ to upload",
